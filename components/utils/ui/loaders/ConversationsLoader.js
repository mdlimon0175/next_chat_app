...
export default function ConversationsLoader() {
    ...
    return (
        <div className={`${conversation_id ? "hidden" : "block"} h-screen sm:block animate-pulse col-span-12 sm:col-span-4 md:col-span-3 border-r c_border bg-softgray dark:bg-charcoal`}>
